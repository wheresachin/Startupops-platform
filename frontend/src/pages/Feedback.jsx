        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-500 text-sm sm:text-base">Validate your ideas with real user insights.</p>
                </div>
            ...
            {/* Stats & Filters */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-white p-4 rounded-xl shadow-sm border border-slate-100 gap-4">
                        ...
                        >
                            <div className="flex justify-between items-start mb-4">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-slate-900">{item.user?.name || 'Anonymous'}</p>
